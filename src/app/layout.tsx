...
export const metadata: Metadata = {
  title: "Coconut Coir Substrate for Agriculture | Pelemix",
  description: "Premium coconut coir grow bags and substrates for sustainable agriculture. Trusted by growers worldwide for optimal plant growth.",
  keywords: "coconut coir, grow bags, agricultural substrates, sustainable farming, horticulture, growing medium",
  ...
  openGraph: {
    ...
    siteName: "Pelemix",
    images: [{
      url: "https://images.pexels.com/photos/33702958/pexels-photo-33702958.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Pelemix coconut coir substrate"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Coconut Coir Substrate for Agriculture | Pelemix",
    description: "Premium coconut coir grow bags and substrates for sustainable agriculture. Trusted by growers worldwide for optimal plant growth.",
    images: ["https://images.pexels.com/photos/33702958/pexels-photo-33702958.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
